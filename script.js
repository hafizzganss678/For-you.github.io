...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Desember 24, 2021 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Assalamualaikum Wr. Wb", " ", "Saya atas nama Muhammand Hafizz pada hari ini 24 desember 2021 dengan sepenuh hati mengucapkan", " ", "<b>Selamat Ulang Tahun !!!</b>", " ", "Kepada Aulyaaa,, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari saya", , " ", "Wassalamualakaikum Wr. Wb", " ", "- Hafizz - ganteng :)"],
  startDelay: 4000,
  speed: 75,
